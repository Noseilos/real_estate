...
<section class="property-details property-details-one">
                    ...
                    <div class="author-widget sidebar-widget">
                        ...
                        <div class="form-inner">
                            ...
                            @auth
                                ...
                                <form action="{{ route('transact.comp') }}" method="POST" class="default-form">
                                    @csrf
                                    ...
                                    <input type="hidden" name="property_id" value="{{ $property->id }}">
                                    <input type="hidden" name="lowest_price" value="{{ $property->lowest_price }}">
                        ...
                        @else
                            <span class="text-danger">Login To Transact</span>
                        @endauth
    ...
    <script type="text/javascript">
        ...
        var stripe = Stripe(
            'pk_test_51Ng4htJvsr9hD9FJ444HAHcKmxK80RK8yakx6MIQPGmaZixyXkRc7Y3Pf4sWWSPoBc6ZlvZkFZ1pxqgv3T7iXQDp00volJLSue'
        );
