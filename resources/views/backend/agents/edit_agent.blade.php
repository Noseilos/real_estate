                                  ...
                                  <form id="myForm" method="POST" action="{{ route('update.agent') }}" class="forms-sample">
                                    @csrf
                                      ...
                                      <div class="form-group mb-3">
                                          ...
                                          <input name="name" type="text" class="form-control" value="{{ $allAgent->name }}">
                                      </div>

                                      <div class="form-group mb-3">
                                          <label for="email" class="form-label">Agent Email</label>
                                          <input name="email" type="email" class="form-control" value="{{ $allAgent->email }}">
                                      </div>

                                      <div class="form-group mb-3">
                                          <label for="phone" class="form-label">Agent Phone</label>
                                          <input name="phone" type="text" class="form-control" value="{{ $allAgent->phone }}">
                                      </div>

                                      <div class="form-group mb-3">
                                          <label for="address" class="form-label">Agent Address</label>
                                          <input name="address" type="text" class="form-control" value="{{ $allAgent->address }}">
                                      </div>
