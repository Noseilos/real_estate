                      ...
                      @csrf
                            <div class="container-fluid d-flex justify-content-between">
                                <div class="col-lg-3 ps-0">
                                    <a href="#"
                                        class="noble-ui-logo logo-light d-block mt-3">Tahanan<span>RealEstate</span></a>
                                    <p class="mt-1 mb-1"><b>Tahanan Real Estate</b></p>
                                    <p>Km 14 East Service Road,<br> Western Bicutan, Taguig City,<br> 1630, Philippines</p>
                                ...
                                <div class="col-lg-3 pe-0">
                                    ...
                                    <h4 class="text-end fw-normal">₱3,000</h4>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-bold-800 text-end"> ₱3,000</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Payment Made</td>
                                                        <td class="text-danger text-end">(-) ₱3,000</td>
                                                    </tr>
                                                    <tr class="bg-dark">
